...
namespace QuestSystemLUA
{
    ...
    {        
        ...
        public void OnInitialize()
        {
            ...
            lua.RegisterFunction("RunTShockCommand", functions, functions.GetType().GetMethod("RunTShockCommand")); //QPlayer player, string commandText, bool serverRuns=false
            lua.RegisterFunction("ModifyVaultBalance", functions, functions.GetType().GetMethod("ModifyVaultBalance")); //QPlayer player, int amount
        }
